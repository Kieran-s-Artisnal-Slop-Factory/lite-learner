<script lang="ts">
  // Read-only view of the cached chapter rows (content + progress). Content
  // is authored in src/content/ — the real chapter pages arrive in Phase 2.
...
{:else if rows.length === 0}
  <p class="muted">No cached chapters yet — chapters are cached when you enroll in a course.</p>
{:else}
